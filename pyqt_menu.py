...
class MainWindow(qw.QMainWindow):
    def __init__(self):
        ...
        label = qw.QLabel('Athena Version:')
        ...
        label = qw.QLabel('Athena Executable:')
        ...
        self.exe.setText('./athena/bin/athena')
        ...
        self.problem.setText('./athinput.linear_wave1d')
        load_layout.addWidget(btn)
        load_layout.addWidget(self.problem)

        self.predef_radio = qw.QRadioButton('Predefined Problem:')
